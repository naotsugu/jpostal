...
class StandardSourceLineTest {
    ...
    private final String str0 = "13103,\"105  \",\"1050022\",\"ﾄｳｷｮｳﾄ\",\"ﾐﾅﾄｸ\",\"ｶｲｶﾞﾝ(1､2ﾁｮｳﾒ)\",\"東京都\",\"港区\",\"海岸（１、２丁目）\",1,0,1,0,0,0";
    private final String str1 = "17201,\"920  \",\"9200946\",\"ｲｼｶﾜｹﾝ\",\"ｶﾅｻﾞﾜｼ\",\"ｵｵｸﾜﾏﾁ(ｶ､ｺ､ｻｵﾂ､ｻｺｳ､ｿ､ﾀ､ﾂｺｳ､ﾅ､ﾒ､ﾕ､ﾖ､\",\"石川県\",\"金沢市\",\"大桑町（カ、コ、サ乙、サ甲、ソ、タ、ツ甲、ナ、メ、ユ、ヨ、\",1,0,0,0,0,0";
    private final String str2 = "17201,\"920  \",\"9200946\",\"ｲｼｶﾜｹﾝ\",\"ｶﾅｻﾞﾜｼ\",\"ﾗ､ﾜ､ｱﾅｶﾞｹ､ｱﾅﾌﾞﾁｶﾞｹ､ﾈ､ｺｳ､ﾖｼｼﾞﾏ､ｼﾓﾖｼｼﾞﾏｶﾞｹ)\",\"石川県\",\"金沢市\",\"ラ、ワ、穴欠、穴淵欠、子、庚、葭島、下葭島欠）\",1,0,0,0,0,0";
